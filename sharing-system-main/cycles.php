...
<body>
  ...
  <section style="text-align: center;background-color:black">
      <img class="php-image" src="images/cycle.jpg"  alt="..." style="height:26%; width:26%;margin-top:5px;padding-bottom:25px;" ><br>
  ...
  <section id="php-form" style="padding:5%;background-color:black">
    <div class="card text-white bg-dark" style="margin-top:0px;margin-bottom:0px">
      ...
      <div class="card-body">
          <form class="card-text" action="cycledata.php" method="post">
            <label for="carusername">Cycle User Name:</label><br>
            <input type="text" id="carusername" name="username"><br>
            <label for="caruserpassword">Cycle User Phone:</label><br>
            <input type="number" id="caruserphone" name="phonenumber"><br>
            <label for="caruseremail">Cycle User Email:</label><br>
